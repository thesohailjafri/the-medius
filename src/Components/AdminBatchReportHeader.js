...
function AdminBatchReportHeader(props) {
    ...
    const send = (chan) => {
        axios.get(`dashboard/api/trigger-channel-manually/?batch_id=${props.id}&channel=${chan}`).then((res)=>{
            console.log(res)
        }).catch((err)=>{
            console.log(err);
        }
    ...
    return (
        ...
        <div className="row d-flex d-wrap justify-between filter-section">
            ...
            <div className="col-md-12 col-lg-6 pt-3 pt-lg-0 text-end">
                <button className="btn btn-primary btn-lg ms-2" onClick={()=>send("WHATSAPP")} >
                    Send Whatsapp
                </button>
                <button className="btn btn-primary btn-lg ms-2" onClick={()=>send("SMS")}>
                    Send SMS
                </button>
                <button className="btn btn-primary btn-lg ms-2" onClick={()=>send("IVR")} >
                    Send IVR
                </button>
                <button className="btn btn-primary btn-lg ms-2" onClick={()=>send("HUMAN_CALL")} >
                    Send Human Call
                </button>
            </div>
...
export default AdminBatchReportHeader;