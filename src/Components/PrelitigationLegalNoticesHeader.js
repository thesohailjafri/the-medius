    ...
    return (
        ...
        <div className="row d-flex d-wrap justify-between filter-section">
            ...
            >
                ...
                <Modal.Body className="ps-3 pe-3">
                                            ...
                                            <div className="row">
                                                <div className="col-lg-4">
                                                    <form className="mt-2 text-start">
                                                        <div className="row mb-3">
                                                            <div className="col-md-12">
                                                                <label for="Batch" className="col-form-label pt-0">Type of Notice to be Issued aaa</label>
                                                                <select id="Batch" className="form-select form-select-s2">
                                                                    <option>Select</option>
                                                                    <option>Arbitration Notice</option>
                                                                    <option>Loan Recall Notice</option>
                                                                    <option>Demand Notice</option>
                                                                    <option>138 Notice</option>
                                                                    <option>Sarfaesi / 13(2) Notice</option>
                                                                </select>
                                                        ...
                                                        <div className="row mb-3">
                                                            <div className="col-md-12">
                                                                ...
                                                                <select id="Batch" className="form-select form-select-s2">
                                                                    <option>Select</option>
                                                                    <option>Type of Notice to be Issued</option>
                                                                    <option>Type of Notice to be Issued</option>
                                                                    <option>Type of Notice to be Issued</option>
                                                                </select>
                                                            </div>
