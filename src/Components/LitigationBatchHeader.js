...
function LitigationBatchHeader(props) {
    ...
    const options = [
        { label: "Sarfaesi / 13(2)", value: "Sarfaesi" },
        { label: "Arbitration", value: "Arbitration" },
        { label: "Section 138", value: "Section_138" },
        { label: "Summary Suit", value: "Summary_Suit" },
    ]
                    ...
                    <form>
                        ...
                        <div className="grey-bg">
                            ...
                            <div className="mb-2 row">
                                ...
                                <div className="col-md-7">
                                    <select id="Bucket" className="form-control">
                                        <option selected>Select</option>
                                        <option>Option 1</option>
                                        <option>Option 2</option>
                                        <option>Option 3</option>
            ...
            >
                <Modal.Header>
                    <Modal.Title id="example-custom-modal-styling-title">
                        Upload New Batch File
                        <Button
                            variant="secondary disabled ms-4"
                            className="">
                            <svg width="14" height="14" xmlns="http://www.w3.org/2000/svg">
                                <g fill="#727272" fill-rule="nonzero">
                                    <path d="M3.85 4.2H1.078C2.45 2.474 3.878.7 7.028.7A6.3 6.3 0 0 1 13.3 7h.7a7 7 0 0 0-6.979-7C3.686 0 2.072 1.837.7 3.553V1.05H0V4.9h3.85v-.7zM10.15 9.8H12.905c-1.4 1.715-2.821 3.5-5.95 3.5A6.3 6.3 0 0 1 .7 7H0a7 7 0 0 0 6.958 7c3.342 0 4.942-1.858 6.342-3.566v2.516h.7V9.1h-3.85v.7z" />
                                </g>
                            </svg>
                            Saving
                        </Button>
                ...
                <Modal.Body className="tab-m-body">
                    <div className="pt-0 pb-5 text-center upload-batch-popup">
                        ...
                        {OnLoadPage &&
                            ...
                            IsUploading ?
                            <Modal.Title id="example-custom-modal-styling-title">
                                <h1 style={{ height: '300px', display: 'grid', placeItems: 'center' }}> <span><VscLoading className='uploader' /> Generating Case Paper</span> </h1>
                            </Modal.Title>
                            :
                            <>
                                <div className="d-flex pt-3 import-step align-center content-center">
                                ...
                                {OnImportPage ?
                                    ...
                                    <>
                                        <div className="w-75 m-auto">
                                            <div className="row">
                                                <div className="col-lg-4 border-right-dotted pe-5">
                                                    <form className="mt-2 text-start">
                                                        <div className="row mb-3">
                                                            <div className="col-md-12">
                                                                <label for="Batch" className="col-form-label pt-0">Type of Case</label>
                                                                <MultiSelect
                                                                    options={options}
                                                                    value={selected}
                                                        ...
                                                        <div className="row mb-4">
                                                            <div className="col-md-12">
                                                                <label for="Batch" className="col-form-label pt-0">State</label>
                                                        ...
                                                        <div className="row mb-4">
                                                            <div className="col-md-12">
                                                                <label for="Batch" className="col-form-label pt-0">Jurisdiction</label>
                                                                <select id="Batch" className="form-select form-select-s2">
                                                                    <option>Select</option>
                                                        ...
                                                        <div className="row mb-4">
                                                            <div className="col-md-12">
                                                                <label for="Batch" className="col-form-label pt-0">Court Complex (Optional)</label>
                                                                <select id="Batch" className="form-select form-select-s2">
                                                                    <option>Select</option>
                                                                    <option>Court Complex (Optional)</option>
                                                                    <option>Court Complex (Optional)</option>
                                                                    <option>Court Complex (Optional)</option>
                                                                </select>
                                                            </div>
...
export default LitigationBatchHeader